...
export const services = [
  ...
  },
  {
    ...
    icon: "Brain",
    features: ["Smart NPCs", "Procedural Gen", "ML Integration", "Behavior Trees"]
  },
  {
    title: "Playable Ads Development",
    description: "Interactive ad experiences that boost engagement and conversions",
    icon: "Megaphone",
    features: ["Interactive Ads", "CPI/CPA", "Multiple Formats", "Analytics"]
  },
  {
    title: "Full-Stack Web Development",
    description: "Enterprise-grade web applications with modern frameworks",
    icon: "Code",
    features: ["React/Next.js", "Node.js", "Databases", "DevOps"]
  },
  {
