  ...
  return (
    ...
    >
      ...
      <div className="container relative mx-auto px-4 lg:px-8">
        <div className="mx-auto grid max-w-3xl grid-cols-1 divide-y divide-zinc-200 sm:grid-cols-3 sm:divide-x sm:divide-y-0 sm:divide-zinc-200">
          {homePageStats.map((stat) => (
            <div key={stat.line1} className="py-6 text-center first:pt-0 last:pb-0 sm:px-4 sm:py-0">
